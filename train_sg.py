...
from utils.loss_sg import ComputeLoss
...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    if pretrained:
        ...
        csd = ckpt #ckpt['model'].float().state_dict()  # checkpoint state_dict as FP32
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        with torch.no_grad():
            ...
            f_acc.write('Accuracy:'+str(accuracy)+'\t Miou:'+str(miou)+'\t lr:'+str(lr[0])+' '+str(lr[1])+' '+str(lr[2])+'\n')
            f_acc.flush()
...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default=ROOT / 'yolov8l.pt', help='initial weights path')
